...
# We need to provide a function that we can call, which we will then take and create a brand new process + execute it
# the parameters we need are:
# box: A bounding box coordinates of the object we are going to track
...
def start_tracker(box, label, rgb, inputQueue, outputQueue):
    ...
    # process so we don need to worry about joining it
    while True:
...
# initialize oir lists of queues -- both input queue and output queue
...
while True:
    ...
    # if we are supposed to be writing a videoto disk, initialize
    # the writer
    ...
    # otherwise, we've already preformed detection so let's track
    # multiple objects
    else:
